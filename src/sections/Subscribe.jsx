...
const Subscribe = () => {
  return (
    <section className="max-container flex justify-center items-center max-lg:flex-col gap-10">
      ...
      <div className="flex items-center max-sm:flex-col gap-5 p-2.5 sm:border
      sm:border-slate-gray rounded-full lg:max-w-[40%] w-full">
        <input type="text" placeholder="some_email@gmail.com" 
        className="input"/>
