...
const SpecialOffer = () => {
  return (
    <section className='flex justify-wrap items-center 
      ...
      <div className='flex flex-col max-sm:wax-w-sm'>
        <h2 className='text-4xl text-bold font-palanquin lg:max-w-lg'><span className="text-coral-red">Special</span> Offer</h2>
        <p className='mt-4 leading-normal lg:max-w-lg info-text'>
